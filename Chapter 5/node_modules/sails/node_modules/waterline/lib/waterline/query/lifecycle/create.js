...
// Helper Functions for processing lifecycle records
var helpers = {
  ...
  processValues: function processValues(values) {
  ...
  createBelongsTo: function createBelongsTo(valuesObject, cb) {
    var self = this;
  ...
  beforeCallbacks: function beforeCallbacks(valuesObject, cb) {
    var self = this;
  ...
  createValues: function createValues(valuesObject, cb) {
    var self = this;
...
var create = function(values, cb) {
  ...
  // Process Values
  var valuesObject = helpers.processValues.call(self, values);

  // Create any of the belongsTo associations and set the foreign key values
  helpers.createBelongsTo.call(self, valuesObject, function(err) {
    if (err) return cb(err);

    helpers.beforeCallbacks.call(self, valuesObject, function(err) {
      if (err) return cb(err);
      helpers.createValues.call(self, valuesObject, cb);
    });
  });
